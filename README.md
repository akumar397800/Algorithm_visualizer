...
**Dijkstra's Algorithm** (weighted): the father of visualising algorithms; guarantees the shortest path

**A* Search** (weighted): arguably the best visualising algorithm; uses heuristics to guarantee the shortest path much faster than Dijkstra's Algorithm
...
**Depth-first Search** (unweighted): a very bad algorithm for visualising; does not guarantee the shortest path

On top of the visualising algorithms listed above, I implemented a **Recursive Division** Maze Generation algorithm.
